...
total_iter = 0
for i in range(1):
    iteration, best_comb, best_traj, reward = deterministic_chinneck_1(scenario_num=2,x0=x0, x_r_list=centroids, time_horizon=tf, reward_max=reward_max,radius_list=radii, \
